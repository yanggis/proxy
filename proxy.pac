...
function FindProxyForURL(i,o){
  var c=i.slice(0,6);return"http:/"===c?_find_proxy(_http_map,o,i,7):"https:"===c?_find_proxy(_https_map,o,i,8):"DIRECT"
}
var _http_map={
  white:{any:[/^[^/]*\/ipad\?file=\//i]},
        proxy:{
          ...
          "api.letv.com":[/^\/streamblock/i,/^\/mms\/out\/video\/play/i,/^\/mms\/out\/common\/geturl/i,/^\/geturl/i,/^\/getipgeo$/i],
          ...
          "spark.api.xiami.com":[/^\/api\?.*method=AuthIp/i,/^\/api\?.*method=Songs\.getTrackDetail/i,/^\/api\?.*method=Songs\.detail/i],
          ...
          "180.153.225.136":[/^\//i],"118.244.244.124":[/^\//i],
          "210.129.145.150":[/^\//i],"182.16.230.98":[/^\//i]
          
        }
  
},_https_map={
  white:{any:[]},proxy:{
    any:[],"openapi.youku.com":[/^\//i],
    "61.135.196.99":[/^\//i],
    "220.181.185.150":[/^\//i],
    "111.13.127.46":[/^\//i],
    "211.151.50.10":[/^\//i],
